...
type Page = 'login' | 'dashboard' | 'servers' | 'patches' | 'apply';
...
export default function App() {
  ...
  const handleNavigate = (page: 'dashboard' | 'servers' | 'patches' | 'apply') => {
    setCurrentPage(page);
  };
  ...
  return (
    <>
      <AppLayout 
        currentPage={currentPage as 'dashboard' | 'servers' | 'patches' | 'apply'} 
